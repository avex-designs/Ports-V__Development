...
(function () {
	if (!KlaviyoSubscribe._loaded) {
		...
		var m = {
			...
			p = {$email: "Email Address", $first_name: "First Name", $last_name: "Last Name"}, h = "klaClosedPopup";
		...
		KlaviyoSubscribe.fetchRequirements = function (a) {
			...
			a = a || {};
			if (window.jQuery) jQuery.fn.ajaxForm ? KlaviyoSubscribe.processQueue() : KlaviyoSubscribe.loadJQueryForm(KlaviyoSubscribe.processQueue); else {
				var b = function () {
		...
		KlaviyoSubscribe.watchField = function (a, b, c) {
			...
			KlaviyoSubscribe.executeWhenRequirementsLoaded(function () {
				...
				if (c.delegate) jQuery(c.delegate).on("change blur", a, d); else jQuery(a).on("change blur", d)
			})
		};
		KlaviyoSubscribe.watchFormSubmission =
			function (a, b) {
				...
				b.list && (KlaviyoSubscribe.bootstrap(), KlaviyoSubscribe.executeWhenRequirementsLoaded(function () {
					...
					if (b.delegate) jQuery(b.delegate).on("submit", a, d); else jQuery(a).on("submit",
						d)
				}))
			};
		KlaviyoSubscribe.attachToForms = function (a, b) {
			...
			KlaviyoSubscribe.executeWhenRequirementsLoaded(function () {
				...
				jQuery(a).each(function () {
					var a = jQuery(this), e = a.data("ajax-submit");
					e || (e = "//manage.kmail-lists.com/ajax/subscriptions/subscribe");
					a.ajaxForm({
						url: e, type: "POST", beforeSubmit: function (b, d, e) {
							try {
		...
		KlaviyoSubscribe.attachToFlyout = function (a, b) {
			...
			KlaviyoSubscribe.executeWhenRequirementsLoaded(function () {
				...
				KlaviyoSubscribe._canShowElem(b) && jQuery(function () {
					var a = b.delay_scroll, e = function () {
						if (!c.data("opened")) {
					...
					if (!1 === a || 0 === a) e(); else {
						var f = jQuery(document), q = jQuery(window), g = "bottom" === a ? 95 : a, k = function () {
		...
		KlaviyoSubscribe.normalizeFormFields = function (a, b, c, d) {
			...
			b.find(".select-date-widget").each(function (b, c) {
				...
				c = d.attr("name");
				var f = b.attr("name"), g = e.attr("name");
		...
		KlaviyoSubscribe.isCurrentLocationInPatterns = function (a) {
			for (var b =
				location.toString(), c = 0, d = a.length; c < d; c++) if (KlaviyoSubscribe.patternMatchesUrl(a[c], b)) return !0;
			return !1
		};
